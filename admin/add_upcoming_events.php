...
$sql=("INSERT INTO `upcoming_events` (`title`,`logo`,`date`,`venue`,`cont`) VALUES('".$title."','".$newname."','".$date."','".$venue."','".$desc."')") or die(mysqli_error());
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-info">
                  <div class="panel-heading panel-heading-divider">Add New Upcoming Events<span class="panel-subtitle"></span></div>
                <div class="panel-body">
                    ...
                    <div class="form-group xs-mt-10">
                      <label for="name" class="col-sm-2 control-label">Events Logo</label>
                      <div class="col-sm-5">
                ...
                <div class="panel-body table-responsive">
                  <table id="table1" class="table table-striped table-hover table-fw-widget">
                   ...
                   if(isset($_GET['dlt'])){
                        ...
                        $dlt_rec="DELETE FROM upcoming_events WHERE id='".$d_id."'";
						unlink("upload/".$img);
                    ...
                    $selelect_data="SELECT * FROM upcoming_events";
                    $exe_data=mysqli_query($con,$selelect_data);
                    ...
                    ?>    
                      <tr class="odd gradeX">
                        ...
                        <td><a href="edit_upcoming_events.php?edit=<?php echo $tbl_data['id']; ?>" class="btn btn-default"><span class="glyphicon glyphicon-pencil"></span></a>
                         <a href="add_upcoming_events.php?dlt=<?php echo $tbl_data['id']; ?>" class="btn btn-danger" onclick="return confirm('Are You Sure To Delete this record?');"><span class="glyphicon glyphicon-trash"></span></a>
                        </td>
                      </tr>
                    <?php } ?>  
                    </tbody>
