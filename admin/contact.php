                ...
                <div class="panel-body table-responsive">
                  <table id="table1" class="table table-striped table-hover table-fw-widget">
                   ...
                   if(isset($_GET['dlt'])){
                        ...
                        $dlt_rec="DELETE FROM contact WHERE id='".$d_id."'";
                    ...
                    $selelect_data="SELECT * FROM contact";
                    ...
                    ?>    
                      <tr class="odd gradeX">
                        ...
                        <td><?php echo $tbl_data['l_name'];?></td> 
                        ...
                        <td><a href="contact.php?dlt=<?php echo $tbl_data['id']; ?>" class="btn btn-danger" onclick="return confirm('Are You Sure To Delete this record?');"><span class="glyphicon glyphicon-trash"></span></a>
                        </td>
                      </tr>
                    <?php } ?>  
                    </tbody>
