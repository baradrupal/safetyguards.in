...
if(isset($_POST["add"]))
{						
						$pro_desc =str_replace("'","\'",$_POST['pro_desc']);
						$newname="";
	...
	$ins_pro=("INSERT INTO `awards`(image,descriptions) VALUES('".$newname."','".$pro_desc."')") or die(mysqli_error());
	...
	window.location='add-certificate.php';
    </script>
	<?php
	}
	else{
              ...
              <div class="panel panel-default panel-border-color panel-border-color-info">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">	
                        <textarea id="elm1" max="50000" name="pro_desc" class="form-control input-sm"></textarea>
                      </div>
                    </div> 
					<div class="form-group">
...
<!--                  <div class="tools"><span class="icon mdi mdi-download"></span><span class="icon mdi mdi-more-vert"></span></div>-->
                ...
                <div class="panel-body table-responsive">
                  <table id="table1" class="table table-striped table-hover table-fw-widget">
                   ...
                   if(isset($_GET['dlt'])){
                        $d_id=$_GET['dlt'];
						$selelect_data="SELECT * FROM awards WHERE id='".$d_id."'";
						$exe_data=mysqli_query($con,$selelect_data);                    
                   		$tbl_data=mysqli_fetch_array($exe_data);  
						$img=$tbl_data['image'];	
						
                        
                        $dlt_rec="DELETE FROM  awards WHERE id='".$d_id."'";
						unlink("upload/".$img);
                        ...
                        if($exe_dlt>0)
                        {
                            ?>
                            <script>                               
                                window.location='add_awards.php';
                            </script>
                            <?php 
                        }else{
                            ?>
                    ...
                    $selelect_data="SELECT * FROM  awards  ORDER BY id DESC";
                    $exe_data=mysqli_query($con,$selelect_data);
                    ...
                    ?>    
                      <tr class="odd gradeX">
                        ...
                        <td><?php echo $tbl_data['descriptions']; ?></td>                                   
                        <td><a href="edit_awards.php?edit=<?php echo $tbl_data['id']; ?>" class="btn btn-default"><span class="glyphicon glyphicon-pencil"></span></a>
                        <a href="add_awards.php?dlt=<?php echo $tbl_data['id']; ?>" class="btn btn-danger" onclick="return confirm('Are You Sure To Delete this record?');"><span class="glyphicon glyphicon-trash"></span></a>
                        </td>
                      </tr>
                    <?php } ?>  
                    </tbody>
