...
if(isset($_POST["update"]))
{
                                ...
                                if($filename=="") 
                                 {
									 $sql_sel="UPDATE `events` SET								 `title`='".$title."',`date`='".$date."',`venue`='".$venue."',`cont`='".$desc."' WHERE `id`=".$arid;
                                 ...
                                 else 
								 {
									...
									$sql_sel="UPDATE `events` SET								 `title`='".$title."',`logo`='".$newname."',`date`='".$date."',`venue`='".$venue."',`cont`='".$desc."' WHERE `id`=".$arid;
									mysqli_query($con,$sql_sel);
                                }
?>
<script>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-info">
				 ...
				 <?php
				$sql_sel="SELECT * FROM `events` WHERE `id`=".$_GET['edit'];
