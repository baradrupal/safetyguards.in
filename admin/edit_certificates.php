...
{
								 $arid=$_POST['edit'];
                                 $title=$_POST['pro_desc'];
                                 $filename = $_FILES['images']['name'];
                                 if($filename=="") 
                                 {                                 
                                    $sql_sel="UPDATE `certificates` SET `descriptions`='".$title."' WHERE `id`=".$arid;
                                 ...
                                 else 
								 {
									...
									$sql_sel="UPDATE `certificates` SET `image`='".$newname."',`descriptions`='".$title."' WHERE `id`=".$arid;
									mysqli_query($con,$sql_sel);
                                }
?>
<script>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-info">
				 ...
				 <?php
				$sql_sel="SELECT * FROM `certificates` WHERE `id`=".$_GET['edit'];
