...
{						
	...
	$ins_pro=("INSERT INTO `certificates`(image,descriptions) VALUES('".$newname."','".$pro_desc."')") or die(mysqli_error());
                ...
                <div class="panel-body table-responsive">
                  <table id="table1" class="table table-striped table-hover table-fw-widget">
                   ...
                   if(isset($_GET['dlt'])){
						...
						$selelect_data="SELECT * FROM certificates WHERE id='".$d_id."'";
						$exe_data=mysqli_query($con,$selelect_data);                    
                   		$tbl_data=mysqli_fetch_array($exe_data);  
						$img=$tbl_data['image'];	
						                     
                        $dlt_rec="DELETE FROM certificates WHERE id='".$d_id."'";
						unlink("upload/".$img);
                    ...
                    $selelect_data="SELECT * FROM certificates  ORDER BY id DESC";
                    $exe_data=mysqli_query($con,$selelect_data);
                    ...
                    ?>    
                      <tr class="odd gradeX">
                        ...
                        <td><a href="edit_certificates.php?edit=<?php echo $tbl_data['id']; ?>" class="btn btn-default"><span class="glyphicon glyphicon-pencil"></span></a>
                        <a href="add-certificate.php?dlt=<?php echo $tbl_data['id']; ?>" class="btn btn-danger" onclick="return confirm('Are You Sure To Delete this record?');"><span class="glyphicon glyphicon-trash"></span></a>
                        </td>
                      </tr>
                    <?php } ?>  
                    </tbody>
