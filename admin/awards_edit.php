...
if(isset($_POST["update"]))
{
                                 ...
                                 if($filename=="") 
                                 {                                 
                                    $sql_sel="UPDATE `awards` SET `descriptions`='".$title."' WHERE `id`=".$arid;
                                 ...
                                 else 
								 {
									...
									$sql_sel="UPDATE `awards` SET `image`='".$hex_string."',`descriptions`='".$title."' WHERE `id`=".$arid;
									mysqli_query($con,$sql_sel);
                                }
?>
<script>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-info">
				 ...
				 <?php
				$sql_sel="SELECT * FROM `awards` WHERE `id`=".$_GET['edit'];
				...
				?>
                    ...
                    <div class="form-group xs-mt-10">
                      ...
                      <div class="col-sm-5">
							<img src="upload/<?php echo base64_decode($row['image']); ?>" style="max-height: 100px;max-width: 100px;"><br/>
