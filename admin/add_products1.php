...
$sql=("INSERT INTO `products`(`pro_name`, `cat_id`,`sub_category`, `image`) VALUES('".$name."','".$type."','".$type1."','".$hex_string."')") or die(mysqli_error());
                   ...
                   if(isset($_GET['dlt'])){
                    ...
                    ?>    
                      <tr class="odd gradeX">
                        ...
                        <td><img src="upload/<?php echo base64_decode($tbl_data['image']); ?>" style="max-height: 70px;max-width: 70px;"></td>
