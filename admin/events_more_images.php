...
$sql=("INSERT INTO `events`(`title`,`logo`,`date`,`venue`,`container`) VALUES('".$title."','".$newname."','".$date."','".$venue."','".$desc."')") or die(mysqli_error());
                ...
                <div class="panel-body table-responsive">
                  <table id="table1" class="table table-striped table-hover table-fw-widget">
                   ...
                   if(isset($_GET['dlt'])){
						...
						$selelect_data="SELECT * FROM events_photo WHERE id='".$d_id."'";
						$exe_data=mysqli_query($con,$selelect_data);                    
                   		$tbl_data=mysqli_fetch_array($exe_data);  
						$img=$tbl_data['image'];
                        
                        $dlt_rec="DELETE FROM events_photo WHERE id='".$d_id."'";
						unlink("upload/".$img);
                    ...
                    $selelect_data="SELECT * FROM events_photo";
                    $exe_data=mysqli_query($con,$selelect_data);
                    ...
                    ?>    
                      <tr class="odd gradeX">
						...
						<td><?php echo $tbl_data['e_id']; ?></td>                         
                        <td><a href="edit_events_moreimages.php?edit=<?php echo $tbl_data['id']; ?>" class="btn btn-default"><span class="glyphicon glyphicon-pencil"></span></a>
                         <a href="events_more_images.php?dlt=<?php echo $tbl_data['id']; ?>" class="btn btn-danger" onclick="return confirm('Are You Sure To Delete this record?');"><span class="glyphicon glyphicon-trash"></span></a>
                        </td>
                      </tr>
                    <?php } ?>  
                    </tbody>
